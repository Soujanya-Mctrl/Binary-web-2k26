        ...
        <div className={`${className} relative w-[20.5rem] h-[5.7rem] lg:w-[25.25rem] lg:h-[7.25rem] `}>
            ...
            >
                <div className="w-[20.5rem] h-[5.7rem] relative flex flex-col justify-center items-center box-border lg:w-[25.25rem] lg:h-[7.25rem]">
                    <p className="absolute font-['SF_Pixelate'] font-bold text-[1.5rem] lg:text-[2rem] leading-[2.875rem] text-white">
                        {title}
                    </p>
                </div>
                <div className="w-[20.5rem] h-[5.7rem] relative flex flex-col justify-center items-center box-border lg:w-[25.25rem] lg:h-[7.25rem]">
                    <p className="absolute font-['SF_Pixelate'] font-bold text-[1.3rem] lg:text-[1.7rem] leading-[2.875rem] text-white">
                        {subtitle}
                    </p>
                </div>
            </div>
